...
from app.services.chat_action_effects import (
    apply_action_effects as _apply_action_effects_impl,
    undo_action_effects as _undo_action_effects_impl,
)


def apply_action_effects(db: Session, action: ChatAction) -> ChatAction:
    return _apply_action_effects_impl(db, action)


def undo_action_effects(db: Session, action: ChatAction) -> ChatAction:
    return _undo_action_effects_impl(db, action)

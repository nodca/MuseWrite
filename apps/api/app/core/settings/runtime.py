...
class RuntimeSettings:
    ...
    FIELD_NAMES: tuple[str, ...] = (
        ...
        "neo4j_gds_graph_name_prefix",
        "retrieval_circuit_breaker_enabled",
        "retrieval_graph_cb_failure_threshold",
        "retrieval_graph_cb_window_seconds",
        "retrieval_graph_cb_open_seconds",
        "retrieval_rag_cb_failure_threshold",
        "retrieval_rag_cb_window_seconds",
        "retrieval_rag_cb_open_seconds",

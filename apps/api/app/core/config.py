...
STRATEGY_DEFAULTS = {
    "local-dev": {
        ...
        # Feature toggles — auto-configured by profile so users need not set them.
        "SEMANTIC_ROUTER_ENABLED": True,
        "SEMANTIC_ROUTER_MODE": "heuristic",
        "BUDGET_ROUTER_ENABLED": True,
        "BUDGET_ROUTER_MODE": "heuristic",
        "SELF_REFLECTIVE_ENABLED": True,
        "SELF_REFLECTIVE_MODE": "auto",
        "CONTEXT_COMPRESSION_ENABLED": True,
        "CONTEXT_PACK_ENABLED": True,
        "CONTEXT_CACHE_ENABLED": True,
        "RETRIEVAL_PARALLEL_ENABLED": True,
        "DETERMINISTIC_SHORT_CIRCUIT_ENABLED": True,
        "GRAPH_TEMPORAL_ENABLED": True,
        "MEMORY_CONSOLIDATION_ENABLED": True,
        "TOT_ENABLED": True,
        "SPATIAL_ENABLED": True,
        "CONSISTENCY_AUDIT_ENABLED": True,
        "CONSISTENCY_AUDIT_AUTO_ENQUEUE": True,
        "ENTITY_MERGE_SCAN_ENABLED": True,
        "ENTITY_MERGE_SCAN_AUTO_ENQUEUE": True,
        "GRAPH_SYNC_ASYNC_ENABLED": True,
        "INDEX_LIFECYCLE_ENABLED": True,
        "CONSISTENCY_AUDIT_LLM_ENABLED": True,
    },
    "quality-first": {
        ...
        "CONTEXT_COMPRESSION_MODE": "rerank",
        # Feature toggles — quality profile enables everything.
        "SEMANTIC_ROUTER_ENABLED": True,
        "SEMANTIC_ROUTER_MODE": "auto",
        "BUDGET_ROUTER_ENABLED": True,
        "BUDGET_ROUTER_MODE": "auto",
        "SELF_REFLECTIVE_ENABLED": True,
        "SELF_REFLECTIVE_MODE": "auto",
        "CONTEXT_COMPRESSION_ENABLED": True,
        "CONTEXT_PACK_ENABLED": True,
...
class Settings:
    ...
    llm_temperature_suggestion = _parse_float(os.getenv("LLM_TEMPERATURE_SUGGESTION"), 0.7)
    ...
    semantic_router_mode = os.getenv("SEMANTIC_ROUTER_MODE", "heuristic")
    ...
    context_compression_reranker_remote_url = os.getenv("CONTEXT_COMPRESSION_RERANKER_REMOTE_URL", "")
    context_compression_reranker_remote_api_key = os.getenv("CONTEXT_COMPRESSION_RERANKER_REMOTE_API_KEY", "")
    context_compression_reranker_remote_model = os.getenv("CONTEXT_COMPRESSION_RERANKER_REMOTE_MODEL", "")
    ...
    budget_router_mode = os.getenv("BUDGET_ROUTER_MODE", "heuristic")
    ...
    # --- Exa Web Search ---
    exa_enabled = _parse_bool(os.getenv("EXA_ENABLED"), False)
    exa_base_url = os.getenv("EXA_BASE_URL", "https://exa.chengtx.vip")
    exa_api_key = os.getenv("EXA_API_KEY", "")
    exa_timeout_seconds = int(os.getenv("EXA_TIMEOUT_SECONDS", "8"))
    exa_default_num_results = int(os.getenv("EXA_DEFAULT_NUM_RESULTS", "5"))
